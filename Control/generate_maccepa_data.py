...
def calculate_torque(deflection_angle, motor2_angle):
	...
	force = 1.0 * k * (B - C + pretension + E + R*lmbda) * sign_deflection_angle
...
for i in range(0, Count):
	for j in range(0, Count):
		...
		torque = calculate_torque(deflection_angle, motor2_angle)
		
		dtorque = calculate_torque((deflection_angle - delta_q), motor2_angle) - torque
...
with open('MACCEPA_res', 'wb') as fp:
